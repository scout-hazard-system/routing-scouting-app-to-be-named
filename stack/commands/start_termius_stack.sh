...
STACK_SCRIPT="$SCRIPT_DIR/run_vehicle_stack.sh"
STREAM_CLIENT="$ROOT_DIR/navigation/frontend/stream_client.py"
DEFAULT_CONFIG="$ROOT_DIR/stack/config/vehicle_stack.env"
