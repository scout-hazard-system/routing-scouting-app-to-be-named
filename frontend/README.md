...
Optional event fields used by the visualizer path:
- `rms` (0..1 float): normalized chunk intensity
- `clip_ratio` (0..1 float): fraction of clipped samples in the chunk
